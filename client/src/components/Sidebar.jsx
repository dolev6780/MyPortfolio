...
export default function Sidebar() {
  ...
  return (
    <div>
       {screenSize.dynamicWidth > 500 ? ( <div className='flex ml-3 mt-10 fixed'>
        <ul>
            <Link to={'/'}>
    ...
    </div>) : ( <div className='flex mt-4 ml-4'>
        
            <Link to={'/'}>
            <motion.p whileHover={{scale:1.2}} className='hover:text-blue-500 hover:bg-opacity-5 hover:bg-blue-300 rounded-full p-2'><HomeIcon fontSize='large'/></motion.p>
            </Link>
            <Link to={'/contact'}>
            <motion.p whileHover={{scale:1.2}} className=' hover:text-blue-500 hover:bg-opacity-5 hover:bg-blue-300 rounded-full p-2'><MailIcon fontSize='large'/></motion.p>
            </Link>
            <Link to={'https://www.linkedin.com/in/dolev-cohen-736763190/'} target="_blank">
            <motion.p whileHover={{scale:1.2}} className=' hover:text-blue-500 hover:bg-opacity-5 hover:bg-blue-300 rounded-full p-2'><LinkedInIcon fontSize='large'/></motion.p>
            </Link>
            <Link to={'https://github.com/dolev6780?tab=repositories'} target="_blank">
            <motion.p whileHover={{scale:1.2}} className=' hover:text-blue-500 hover:bg-opacity-5 hover:bg-blue-300 rounded-full p-2'><GitHubIcon fontSize='large'/></motion.p>
            </Link>
